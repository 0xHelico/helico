...
| What | Where |
|---|---|
| Universal Router `execute`, `V4_SWAP` command, router-level `SWEEP` | [`swap.ts#L100-L121`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/packages/plugins/uniswap/src/swap.ts#L100-L121) |
| `SWAP_EXACT_IN_SINGLE` action and its settlement pair | [`swap.ts#L148-L170`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/packages/plugins/uniswap/src/swap.ts#L148-L170) |
| `Quoter` read over `eth_call` | [`quote.ts#L17-L28`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/packages/plugins/uniswap/src/quote.ts#L17-L28) |
| Pool state through `StateView` | [`pool.ts#L64-L82`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/packages/plugins/uniswap/src/pool.ts#L64-L82) |
| `PoolId` derivation, matching v4's own | [`pool.ts#L39-L52`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/packages/plugins/uniswap/src/pool.ts#L39-L52) |
| Addresses resolved from the official SDK | [`addresses.ts#L99-L107`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/packages/plugins/uniswap/src/addresses.ts#L99-L107) |
| Permit2 approval | [`approval.ts#L93-L110`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/packages/plugins/uniswap/src/approval.ts#L93-L110) |
| EIP-712 `PermitSingle` typed data | [`approval.ts#L134-L160`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/packages/plugins/uniswap/src/approval.ts#L134-L160) |
| `PositionManager` mint | [`liquidity.ts#L93-L124`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/packages/plugins/uniswap/src/liquidity.ts#L93-L124) |
...
| What | Where |
|---|---|
| The mandate a user commits | [`Mandate.sol#L20-L62`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/contracts/src/Mandate.sol#L20-L62) |
| Committing it, checked against the position's real pool | [`HelicoVault.sol#L226-L246`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/contracts/src/HelicoVault.sol#L226-L246) |
| The action the agent may propose | [`HelicoVault.sol#L321-L374`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/contracts/src/HelicoVault.sol#L321-L374) |
| Every range rule, including the one the price must satisfy | [`HelicoVault.sol#L583-L607`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/contracts/src/HelicoVault.sol#L583-L607) |
| The swap that makes an out-of-range position recoverable | [`HelicoVault.sol#L381-L397`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/contracts/src/HelicoVault.sol#L381-L397) |
| The exit, which nothing can block | [`HelicoVault.sol#L256-L261`](https://github.com/0xHelico/helico/blob/fe6c2610063c464bbe5c05f87230ccb47bf5520b/contracts/src/HelicoVault.sol#L256-L261) |
